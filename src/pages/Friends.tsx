...
export const Friends: React.FC = () => {
  return (
    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <header className="reveal flex justify-between items-end">
        ...
        {friends.length === 0 ? (
          ...
          friends.map((friend) => (
            <a 
              ...
              className="interactive group p-6 bg-white rounded-3xl border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-500 flex flex-col items-center text-center space-y-4"
            >
